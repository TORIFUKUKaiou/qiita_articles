---
title: Phoenix 1.7.0-rc.0 を楽しむ（Elixir）
tags:
  - Elixir
  - Phoenix
  - 40代駆け出しエンジニア
  - AdventCalendar2022
private: false
updated_at: '2023-02-25T14:17:52+09:00'
id: e6e94e9742029a608b1d
...
<blockquote class="twitter-tweet"><p lang="en" dir="ltr">Phoenix 1.7.0-rc.0 is out! So much good stuff in this release – <a href="https://twitter.com/tailwindcss?ref_src=twsrc%5Etfw">@tailwindcss</a> by default, HTML-aware component system with compile-time checks, verified routes, and more!<br><br>👉<a href="https://t.co/lMjW4fGEKd">https://t.co/lMjW4fGEKd</a></p>&mdash; Chris McCord (@chris_mccord) <a href="https://twitter.com/chris_mccord/status/1589721565692067840?ref_src=twsrc%5Etfw">November 7, 2022</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>

さっそく試してみました。
すでに試された方もいらっしゃるとおもいます。
ざーっと表面的なことだけを速報しておきます。

Phoenix 1.7.0-rc.0 のデフォルトプロジェクトを立ち上げたときの図です。

![スクリーンショット 2022-11-08 9.31.24.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/131808/35c26155-13ab-7eb0-9eb0-ffbed69839d2.png)


# ドキュメント

[Phoenix 1.7-rc released: Built-in Tailwind, Verified Routes, and more](https://phoenixframework.org/blog/phoenix-1.7-released)が、[Chris McCord](https://twitter.com/chris_mccord)御大が書かれたドキュメントです。

https://phoenixframework.org/blog/phoenix-1.7-released
...
[Elixir](https://elixir-lang.org/)は1.14以上が必要とのことです。
私は、[asdf](https://asdf-vm.com/)を使っています。
以下のようにしてインストールしました。
...
インストールできました:tada::tada::tada::tada::tada:
...
![スクリーンショット 2022-11-08 9.31.24.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/131808/8f090168-a8ce-059b-534d-67c6c0bc0f98.png)

うぉーかっこいい！！！

以下、速報レベルでさらっと書いておきます。

# [TailwindCSS](https://tailwindcss.com/)がデフォルト

カッコいいトップ画面の`.heex`はこれです。

> Phoenix 1.7 ships with TailwindCSS by default, with no dependency on nodejs on the system.
です。

[TailwindCSS](https://tailwindcss.com/)がデフォルトです。

```elixir:lib/hello_web/controllers/page_html/home.html.heex
...
`hello_web`の下がだいぶ異なります。
`tailwind.config.js`ファイルが最初からあります。
...
[Chris McCord](https://twitter.com/chris_mccord)御大がかかれた[ドキュメント](https://phoenixframework.org/blog/phoenix-1.7-released)の先頭で触れらているのは、「Verified Routes」です。

@the_haigo さんの記事をご参照ください。
