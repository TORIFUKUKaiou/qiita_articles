---
title: 闘魂Elixir ーー AtCoder Beginner Contest 354(A)をElixirで楽しむ
tags:
  - AtCoder
  - Elixir
  - 猪木
  ...
  - AdventCalendar2024
private: false
updated_at: '2024-06-14T19:55:27+09:00'
id: 756b74a3df6dd101cc0a
...
defmodule Main do
  ...
  def solve(h) do
    ...
    |> Enum.reduce_while(0, fn i, acc ->
      new_acc = acc + 2 ** i
      if new_acc > h, do: {:halt, i + 1}, else: {:cont, new_acc}
    end)
  end
end
```
