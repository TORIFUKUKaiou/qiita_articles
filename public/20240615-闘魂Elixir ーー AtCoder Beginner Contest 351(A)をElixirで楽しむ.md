---
title: 闘魂Elixir ーー AtCoder Beginner Contest 351(A)をElixirで楽しむ
tags:
  - AtCoder
  - Elixir
  - 猪木
  ...
  - AdventCalendar2024
private: false
updated_at: '2024-06-15T11:28:57+09:00'
id: 30c874c59b77660c7c2f
...
野球のスコアボードを題材にした問題です。
リストの要素の足し算をすればよいわけで、[Enum.sum/1](https://hexdocs.pm/elixir/Enum.html#sum/1)関数が大活躍です。
...
defmodule Main do
  ...
  def solve(a_list, b_list) do
    Enum.sum(a_list) - Enum.sum(b_list) + 1
  end
end
```
