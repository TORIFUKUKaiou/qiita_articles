---
title: 闘魂Elixir ーー AtCoder Beginner Contest 401(A)をElixirとRustで楽しむ
tags:
  - Rust
  - AtCoder
  - Elixir
  ...
  - 闘魂
private: false
updated_at: '2025-06-29T23:59:11+09:00'
id: 08b791a58f39cf4854b8
...
関数のパターンマッチとガード節を使って場合分けをするようにコーディングしました。  
...
defmodule Main do
  ...
  def solve(s) when 200 <= s and s <= 299, do: "Success"
  def solve(_s), do: "Failure"
end
```
