...
tags:
  ...
  - AIではなく人間が書いてます
private: false
updated_at: '2025-11-04T21:32:10+09:00'
...
シンプルですが、深い意味があります。データが流れる道、処理が進む道。パイプライン演算子はまさに「道」を作ります。

プログラミングも同じです。データの流れに逆らわず、自然に処理を繋げていく。それがElixirのパイプライン演算子 `|>` の哲学です。
...
パイプライン演算子 `|>` は、Elixirの最も美しい機能の一つです。
