---
title: 闘魂Elixir ーー AtCoder Beginner Contest 333(A)をElixirで楽しむ
tags:
  - AtCoder
  - Elixir
  - 猪木
  ...
  - AdventCalendar2024
private: false
updated_at: '2024-06-21T10:49:46+09:00'
id: fedc420bd06fb81e802d
...
文字列の複製には、[String.duplicate/2](https://hexdocs.pm/elixir/String.html#duplicate/2)を使いました。
...
defmodule Main do
  def main do
    ...
    String.duplicate(n, String.to_integer(n))
    |> IO.puts()
  end
end
```
